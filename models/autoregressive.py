...
class ARModel(pl.LightningModule):
    ...
    def __init__(
        ...
        state_feature_weights = get_state_feature_weighting(
            config=args.loss_weight_config, datastore=datastore
        )
    ...
    def predict_step(self, now_state, forcing):
        ...
        now_state: (B, num_grid_nodes, feature_dim), X_t  forcing: (B, num_grid_nodes,
        forcing_dim)
        """
