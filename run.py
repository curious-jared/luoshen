...
def main(input_args=None):
    ...
    parser.add_argument(
        "--clamping",
        action="store_true",
        help="If clamp the output in a  certain range (default: False)",
    )
    ...
    parser.add_argument(
        ...
        type=str,
        default="manual",
        help="Loss weights config (manual/uniform) (default: manual)",
    )
    ...
    # Load datastore to use
    datastore = utils.load_datastore(datastore_kind = args.datastore_kind,config_path=args.config_path)
